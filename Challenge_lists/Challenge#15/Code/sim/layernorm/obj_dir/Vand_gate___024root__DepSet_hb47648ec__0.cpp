...
#endif
            VL_FATAL_MT("../../rtl/and_gate.sv", 2, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../../rtl/and_gate.sv", 2, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../../rtl/and_gate.sv", 2, "", "Active region did not converge.");
            }
